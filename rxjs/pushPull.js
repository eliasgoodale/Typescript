...
var obsFoo = rxjs_1.Observable.create(function (observer) {
    console.log('Hello');
    observer.next(42);
});
obsFoo.subscribe(function (x) { return console.log(x); });
obsFoo.subscribe(function (y) { return console.log(y); });
/*
...
var obsBar = rxjs_1.Observable.create(function (observer) {
    console.log('Hello');
    observer.next(42);
...
obsBar.subscribe(function (x) { return console.log(x); });
